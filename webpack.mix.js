...
mix.js('resources/js/mainpage.js', 'public/js').vue()
   ...
   .ts('resources/js/prostitution/prostitution_notices_list.ts', 'public/js').vue()
   .ts('resources/js/prostitution/prostitution_browse.ts', 'public/js').vue()
   .ts('resources/js/prostitution/show_announcement_details.ts', 'public/js').vue()
   .sass('resources/sass/prostitution/prostitution_notices_list.scss', 'public/css').vue()
   ...
   .sass('resources/sass/prostitution/prostitution_browse.scss', 'public/css')
   .sass('resources/sass/prostitution/show_announcement_details.scss', 'public/css')
