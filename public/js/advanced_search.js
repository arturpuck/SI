...
var MoviesList = /** @class */ (function (_super) {
    ...
    MoviesList = __decorate([
        vue_property_decorator_1.Component({ components: { MovieBox: movie_box_vue_1.default } })
    ], MoviesList);
    return MoviesList;
}(vue_property_decorator_1.Vue));
