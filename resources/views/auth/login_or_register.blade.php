	...
	<div class="mainpage-background mainpage-background-number-{{$randomImageNumber}}">
		...
		<main id="main-panel" class="main-panel @if($errors->any())main-panel-without-top-margin @endif">
			<section class="login-or-register-panel">
				...
				<form ref="login_panel" action="/login" method="POST" id="login-form" class="main-panel-form @if(($errors->any() and old('register_panel_selected')) or (isset($visibleForm) and ($visibleForm === 'registration'))) hidden-section-element @endif">
					@csrf
				...
				<form ref="register_panel" method="POST" action="/register" class="main-panel-form register-form @if(($errors->any() and !old('register_panel_selected')) or (isset($visibleForm) and ($visibleForm === 'login'))) hidden-section-element @endif">
					@csrf
