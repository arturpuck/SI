<x-base title="{{__('contact_management')}}" customBodyClass="{{$customBodyClass}}" action="{{route('contact.send.message')}}" description="{{__('contact_form_allows_you_to_contact_management')}}">
