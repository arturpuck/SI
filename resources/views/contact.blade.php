<x-base title="{{__('contact_management')}}" specificImageClass="{{$specificImageClass}}" action="{{route('contact.send.message')}}" description="{{__('contact_form_allows_you_to_contact_management')}}">
