<template>
  <nav v-show="pagesListShoulBeDisplayed" class="pages-list">
    <div class="pages-list__scrollable-controls">
        ...
        <button v-if="arrowsShouldBeDisplayed" v-on:click="scrollLinks(rightScrollDirection)" v-on:mousedown="scrollLinksByMouseDown(rightScrollDirection)" v-on:mouseup="stopScrollingFromMouseDown" v-bind:title="descriptions['nextLinksDescription']" class="pages-list__scroll-pages-button--arrow-right">
            <span v-text="descriptions['nextLinksDescription']" class="pages-list__button-description"></span>
        </button>
    </div>
