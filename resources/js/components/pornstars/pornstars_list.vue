  ...
  <div class="pornstars-list-container">
    ...
    <ul class="pornstars-list">
      <li v-for="pornstarNickname in displayedPornstars" class="pornstar-preview">
        ...
        >
          <img
            class="pornstar-preview-image"
            v-bind:src="getPornstarImageFilePath(pornstarNickname)"
          />
    ...
    <div v-show="showNoResultsInfo" class="no-results-message">
      ...
      <span
        v-text="translations['no_results_has_been_found']"
        class="no-results-text"
      ></span>
      <button
        v-text="translations['reset_search_button_caption']"
        v-on:click="resetSearchInput"
