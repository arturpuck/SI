<template>
<div class="search-field-container"  v-bind:class="{'focused-input-container' : focus, 'top-corners-rounded-container' : hintsAreDisplayed}">
   <label v-text="description" for="hinted-search-text" class="search-field-description"></label>
   <div v-bind:class="{'top-left-corner-rounded' : hintsAreDisplayed}" class="icon-container">
