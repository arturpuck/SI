<template>
  <section v-show="showCategories" class="categories-panel">
     ...
     <ul class="categories-list">
        <li v-for="category in categories" v-bind:key="category.fileName" v-bind:style="{backgroundImage : `url(/images/decoration/categories/categories_list/${category.fileName}.jpg)`}" class="categories-list__element">
            <a v-bind:href="`/filmy/kategoria/${category.slug}`" class="categories-list__link">
