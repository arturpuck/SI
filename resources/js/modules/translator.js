...
export default {
   ...
   pl: {
      ...
      prostitution_offer_bottom_navigation_info : "Ogłoszenie zostało podzielone na sekcje, użyj strzałek lub rozwijanej listy powyżej aby przejść dalej",
      ...
      most_important_services_description : "Poniżej lista najważniejszych usług jakimi interesują się klienci. Aktualnie ceny podawane są w złotówkach. Pracujemy nad cennikiem w innych walutach. Prosimy o uważne wypełnienie informacji, ułatwi to użytkownikom wyszukiwanie i Tobie pomoże znaleźć klientów. Jeżeli formularze nie do końca odpowiadają Twej ofercie możesz doprecyzować to w opisie w dalszej sekcji.",
      remaining_services_description : "Pozostałe usługi nie ujęte na liście najważniejszych",
