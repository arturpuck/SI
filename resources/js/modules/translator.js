...
export default {
   ...
   pl: {
      ...
      announcement_description : "Treść ogłoszenia, opis",
      ...
      prostitution_announcements_are_free : "Dodawanie ogłoszeń jest całkowicie darmowe. Obowiązują następujące zasady. Jeżeli dodajesz więcej niż 1 ogłoszenie, oferty te muszą wyraźnie różnić się zakresem wykonywanych usług, lub dotyczyć innej osoby(jeżeli jesteś np. właścicielem salonu masażu i masz więcej panienek pod sobą). ",
      ...
      announcement_will_not_be_added_immidiatelly : "Ogłoszenie nie zostanie dodane natychmiastowo, musi najpierw zostać zweryfikowane przez administrację. Czas weryfikacji to maksimum 48 godzin. ",
      ...
      comments_are_filtered_by_admins_to_prevent_revealing_classified_information : "Jednocześnie przed opublikowaniem jakiegokolwiek komentarza administracja dba o to aby nie zostały upublicznione poufne dane takie jak adres, imie i nazwisko itp. ",
