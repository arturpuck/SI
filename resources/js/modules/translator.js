...
export default {
   ...
   pl: {
      ...
      dont_hide : "nie ukrywaj",
      announcement_has_been_hidden : "Ogłoszenie zostało ukryte dla użytkowników",
      announcement_is_visible : 'Ogłoszenie jest widoczne dla użytkowników',
      ...
      announcements_cannot_be_displayed_because_an_error_occured : "Nie można wyświetlić listy ogłoszeń ponieważ pojawił się błąd",
      ...
      my_notices : "Moje ogłoszenia",
      an_erroc_occured_while_fetching_announcements_list : "Błąd podczas pobierania listy ogłoszeń",
      error: "Błąd",
      log_in : "Zaloguj",
      male : "mężczyzna",
      female : "kobieta",
      ...
      scroll_left : "Przewijaj w lewo",
      scroll_right: "Przewijaj w prawo",
      ...
      comment_body : "Treść komentarza",
      nickname: "Pseudonim",
      answears : "Odpowiedzi",
      add_comment: "Dodaj komentarz",
      photosAreValidAndUpToDate : "zweryfikowane zdjęcia",
      region : "województwo",
      add: "dodaj",
      contents : "Treść",
      ...
      comment_submitted_awaits_verification : "Wysłano komentarz, oczekuje on na weryfikację",
      ...
      small_ass: "mały",
      age : "wiek",
      fetching_announcements : "Pobieram ogłoszenia",
      medium_ass: "średni",
      big_ass: "duży",
      small_tits: "małe",
      medium_tits: "średnie",
      ...
      these_photos_currently_await_validation : "Te zdjęcia lub część z nich aktualnie czekają na weryfikację",
      saving_notice : "Zapisywanie ogłoszenia",
      announcement_update_info : "Wszelkie informacje zostaną zaktualizowane natychmiast, jeżeli dodano jakiekolwiek nowe zdjęcia, należy poczekać na weryfikację - do tego momentu wyświetlane będę zdjęcia z przed zmiany. Jeżeli tylko usunięto zdjęcie zmiana będzie widoczna natychmiast i nie trzeba czekać na weryfikację. Przypominamy, że zmiana daty urodzenia nie jest możliwa.",
      announcement_must_be_validated_reminder : "Proszę pamiętać, że ogłoszenie nie zostanie dodane natychmiast. Musi najpierw zostać zweryfikowane, jednakże nie dłużej niż 48 godzin. ",
      ...
      nothing_has_been_modified : "Nic nie zostało zmodyfikowane od ostatniego zapisu",
      ...
      fetching_announcements : "Pobieram ogłoszenia",
      you_dont_have_any_announcements : "Nie posiadasz żadnych ogłoszeń",
      city : "Miasto",
      hidden_by_a_user : "Ukryte przez użytkownika",
      not_valid_awaiting_verification_not_visible_for_users: "Nieważne, niewidoczne dla użytkowników. Czeka na weryfikację",
      monday : "poniedziałek",
      actions : "działania",
      ...
      use_old_token : "Użyj starego tokena",
      ...
      two_types_of_photo_edition_is_available : "Są możliwe 2 rodzaje edycji zdjęć",
      announcement_has_been_successfully_updated : "Pomyślnie zaktualizowano ogłoszenie",
      prolonging_prostitution_announcement : "Przedłużanie ogłoszenia o kolejne 3 miesiące",
      updating_prostitution_announcement_until_expiration_date : "Zmiana bez przedłużania",
      if_you_want_to_prolong_your_prostitution_announcement : "Jeżeli chcesz przedłużyć ważność Twego ogłoszenia o kolejne 3 miesiące musisz dodać zdjęcia z świeżo wygenerowanym tokenem. Ważne jest aby każde zdjęcie zawierało jeden i ten sam świeżo wygenerowany token. Aby wygenerować nowy token kliknij w przycisk poniżej.",
      ...
      if_you_dont_want_to_prolong_your_prostitution_announcement : "Jeśli nie zależy Ci na przedłużaniu daty ważności ogłoszenia, należy dodać zdjęcia ze starym tokenem wygenerowanym po ostatniej akceptacji. Usuwanie zdjęć odbywa się natychmiast bez konieczności akceptowania.",
      old_token : "stary token",
      profile_picture_of_a_prostitute_with_nickname : "Zdjęcie profilowe prostytutki o pseudonimie",
