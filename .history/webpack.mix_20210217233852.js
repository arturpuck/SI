...
.ts('resources/js/movies/movies_set_complete.ts', 'public/js')
.ts('resources/js/pornstars/pornstars_list.ts', 'public/js')
.ts('resources/js/pornstars/pornstar_profile.ts', 'public/js')
.ts('resources/js/advanced_search.ts', 'public/js')
